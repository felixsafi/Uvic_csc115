...
public class Lab1Part1Tester {
	...
	public static void testCountAbove() {
		...
		System.out.println("threshold: 2, on a0: "+ Lab1.getString(a0));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");

		expected = 1;
		result = Lab1.countAbove(a1,0);
		System.out.println("threshold: 0, on a1: " + Lab1.getString(a1));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");

		expected = 4;
		result = Lab1.countAbove(a2,-1);
		System.out.println("threshold: -1, on a2: " + Lab1.getString(a2));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");

		expected = 3;
		result = Lab1.countAbove(a2,0);
		System.out.println("threshold: 0, on a2: " + Lab1.getString(a2));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");

		expected = 1;
		result = Lab1.countAbove(a2,2);
		System.out.println("threshold: 2, on a2: " + Lab1.getString(a2));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");

		expected = 2;
		result = Lab1.countAbove(a3,2);
		System.out.println("threshold: 2, on a3: " + Lab1.getString(a3));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result+"\n");
	}
